...
if Tipo==1
    ...
    if opcion==2
        ...
        hf1=H;
        ds=input('digite un diametro comercial pequeño en pulgadas: ');
        tol=0.001;
        centinela=true;
        while centinela
            cumple=0;
...
if Tipo==2
    %Datos entrada
    ntubos=input('digite el numero de tuberías: ');
    ...
    %comprobacion
    if opcion==1
        %pedir los diametros de las n tuberías y q lateral
        for i=1:ntubos
            disp('tubería');disp(i);
            d=input('digite el diámetro en pulgadas: ');disp(i); Vd(i)=d*0.0254;
